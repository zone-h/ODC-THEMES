                        ...
                        <article class="post-wrapper">
                          ...
                          <footer class="entry-footer">
                            ...
                            <ul class="list-inline right share-post">
                                <li><a name="fb_share" href="http://www.facebook.com/sharer.php?u=<?php echo site_url().'first/artikel/'.$single_artikel['id']?>"><i class="fa fa-facebook"></i> <span>Share</span></a>
                                </li>
                            ...
                            <div class="panel-body">
                              <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="facebook-comment">
                                    <p>
                                    	<div class="fb-comments" data-href="https://developers.facebook.com/docs/plugins/comments#configurator" data-width="100%" data-numposts="10">
                                    		<div placeholder>
											    <div class="loading">
