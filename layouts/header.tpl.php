            ...
            <div class="header-sticky light-header ">
                ...
                <div class="container">
                    ...
                    <div id="materialize-menu" class="menuzord">
                        ...
                        <!-- <a href="<?php echo site_url('first'); ?>" class="pull-left" style="color: skyblue;">
                            <div class="wrapper-logo-text-brand">
                                <img src="<?php echo LogoDesa($desa['logo']) ?>" class="logo-text-brand-image">
                                <div class="logo-text-brand-text"><span class="logo-text-brand-span"><?php echo ucwords($this->setting->sebutan_desa) . ' ' . $desa['nama_desa'] ?></span><br /><?php echo ucwords($this->setting->sebutan_kecamatan . ' ' . $desa['nama_kecamatan'] . ' - ' . $desa['nama_kabupaten']) ?></div>
                            </div>
                        </a> -->
                        <!--logo end-->
                        ...
                        <ul class="menuzord-menu pull-right">
                            ...
                            <?php /*}else{*/ ?>
                            <!-- <li><a href="javascript:void(0)">Mandiri</a></li> -->
                        	<?php } ?>
                            <li><a href="javascript:void(0)">Kategori</a>
                                <div class="megamenu">
                                    <div class="megamenu-row">
                                        ...
                                        <div class="col3">
                                            <h2><a href="<?php echo site_url()."first/kategori/".$sub['id']?>" style="font-weight: bold;"><?php echo $sub['nama']; ?></a></h2>
                                            <?php if(count($data['submenu'])>0): ?>
                                            <ul class="list-unstyled clearfix">
                                                <?php foreach($sub['submenu'] as $submenu): ?>
